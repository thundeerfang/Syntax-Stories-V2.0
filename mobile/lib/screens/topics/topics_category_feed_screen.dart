...
import '../../widgets/topics/category_follow_button.dart';
...
class _TopicsCategoryFeedScreenState extends State<TopicsCategoryFeedScreen> {
  ...
  int get _displayCount {
    ...
    final indexed = widget.category.postCount;
  ...
  Widget _buildBody(BuildContext context, List<BlogFeedPost> filtered) {
...
class _CategoryFeedEmptyState extends StatelessWidget {
  const _CategoryFeedEmptyState({required this.searching});

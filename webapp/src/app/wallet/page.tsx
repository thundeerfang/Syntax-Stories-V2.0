...
export default function WalletPage() {
  return (
    <div className="mx-auto flex min-h-[min(70vh,36rem)] max-w-lg flex-col items-center justify-center px-6 py-16 text-center">
      ...
      <Link
        href="/"
        className="mt-10 inline-flex items-center justify-center border-2 border-border bg-card px-6 py-3 text-[10px] font-black uppercase tracking-widest text-foreground shadow transition-all hover:translate-x-px hover:translate-y-px hover:shadow-none"
      >
        Back to home
      </Link>
    </div>

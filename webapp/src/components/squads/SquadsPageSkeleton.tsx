...
function SquadCardSkeletonTile() {
  return (
    <div
      className="flex h-full min-h-[13rem] flex-col border-2 border-border bg-card p-4 shadow-[3px_3px_0_0_var(--border)]"
      aria-hidden
    >
...
export function SquadsPageContentSkeleton() {
  return (
    <div className="w-full space-y-4" aria-hidden>
      <div className="flex h-[58px] w-full animate-pulse items-center justify-between gap-3 border-2 border-border bg-white px-3 shadow-[4px_4px_0_0_var(--border)] dark:bg-card sm:h-[62px] sm:px-4">
        <div className="flex min-w-0 flex-1 flex-wrap items-center gap-1">
          <SkBlock className="h-[42px] w-[7.25rem] rounded-none border-2 border-border bg-muted/25" />
          <SkBlock className="h-[42px] w-[5.25rem] rounded-none border-2 border-border bg-muted/15" />
          <SkBlock className="h-[42px] w-[5.75rem] rounded-none border-2 border-border bg-muted/15" />
          <SkBlock className="h-[42px] w-[8.5rem] rounded-none border-2 border-border bg-muted/15" />
        </div>
        <div className="flex shrink-0 items-center gap-2">
          <SkBlock className="h-[42px] w-36 rounded-none border-2 border-border bg-muted/15 sm:w-44" />
          <SkBlock className="h-[42px] w-28 rounded-none border-2 border-border bg-muted/15 sm:w-32" />
        </div>
      </div>

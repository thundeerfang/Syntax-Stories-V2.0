...
import { SQUAD_CATEGORIES, SQUAD_CATEGORY_LABEL } from '@/lib/squadCategory';
      ...
      >
        <div className="flex flex-col gap-6">
            ...
            >
              <button
                ...
                className={cn(
                  ...
                  visibility === 'public'
                    ? 'border-primary bg-primary/10 shadow-[3px_3px_0_0_var(--border)]'
          ...
          <section className="grid gap-3 border-t border-border pt-4">
            ...
            <div className="flex flex-col gap-2 rounded-md border-2 border-border bg-muted/10 px-3 py-3 sm:flex-row sm:items-center sm:justify-between">
              <div>

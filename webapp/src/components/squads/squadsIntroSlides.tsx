import type { InfoSwiperSlide } from '@/components/ui/InfoSwiperDialog';
  ...
  },
  {
    ...
    body: (
      <div className="space-y-3 text-left">
        <p>
          <span className="mr-2 rounded-sm bg-violet-500 px-1.5 py-0.5 text-[10px] font-black uppercase text-white">
            New
          </span>

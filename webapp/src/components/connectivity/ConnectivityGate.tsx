...
function ConnectionSegment({
  ...
  return (
    <div
      className={cn(
        'h-1 min-w-[2.5rem] flex-1 rounded-full transition-colors duration-300',
          ...
          >
            ...
            >
              <div className="flex flex-col items-center px-5 py-8 text-center sm:px-8">
                ...
                >
                  <span className="inline-flex size-1.5 animate-pulse rounded-full bg-primary" aria-hidden />
                  Reconnecting…
                </p>

...
import {
  CLOUD_ROBOTICS_LOTTIE_SRC,
  CONNECTIVITY_GATE_Z,
  CONNECTIVITY_RELOAD_AFTER_RECOVERY_MS,
} from "@/variable";
...
export function ConnectivityGate() {
  ...
  const title =
    gate === "offline" ? "No internet connection" : "Can't reach the server";
  const subtitle =
    gate === "offline"
      ...
      {blocked && (
        <>
          <motion.div
            ...
            style={{ zIndex: CONNECTIVITY_GATE_Z }}
            aria-hidden
          ...
          >
            ...
            >
              <div className="flex flex-col items-center px-5 py-8 text-center sm:px-8">
                ...
                >
                  <span
                    className="inline-flex size-1.5 animate-pulse bg-primary"
                    aria-hidden
                  />
                  Reconnecting…
                </p>

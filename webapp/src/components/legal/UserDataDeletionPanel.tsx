        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:gap-5">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className={LEGAL_ACTION_BODY}>
              Send a request from this signed-in account. We process it
              according to the policy above, including any subscription billing
              or legal-hold rules described there.
            </p>
          </div>
        </div>

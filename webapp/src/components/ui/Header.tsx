  ...
  return (
    <header
      className={cn(
        ...
        'overflow-hidden border-4 border-border bg-card shadow-[8px_8px_0_0_var(--border)]',
        className
      )}
    >
      <div className="flex flex-wrap items-center gap-3 border-b-4 border-border bg-muted/40 px-4 py-3 sm:px-6">
        <span
          className="flex size-9 shrink-0 items-center justify-center border-2 border-border bg-card shadow-[2px_2px_0_0_var(--border)]"
          aria-hidden
        >

...
export function ProfilePopoverCard({
  ...
  if (profileHref) {
    return (
      <Link
        href={profileHref}
        className="block w-[260px] border-2 border-border bg-card shadow outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
      >
        {inner}
      </Link>
    );

              ...
              {showLinkPanel && (
                <>
                    ...
                    <div className="min-w-0 flex-1 space-y-2">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="w-full border border-border px-2 py-2 text-xs bg-background focus:outline-none focus:border-primary"
                        />
                      </div>
                    </div>
                  ...
                  <div className="mt-3 flex justify-end gap-2">
                    <button
                      type="button"
                      className="px-3 py-1.5 border border-border text-[10px] font-semibold uppercase tracking-wide transition-colors hover:bg-muted"
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 border border-border bg-primary text-primary-foreground text-[10px] font-bold uppercase tracking-wide hover:brightness-110 disabled:pointer-events-none disabled:opacity-40"
                      onClick={applyLink}
                    >
                      Apply
                    </button>

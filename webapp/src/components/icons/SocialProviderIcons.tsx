...
/** Twitch mark (`public/svg/twitch.svg`). */
export function TwitchIcon({ className }: Readonly<IconProps>) {
  return <img src={SOCIAL_ICON_TWITCH} alt="" className={cn('object-contain', className)} />;
}
...
/** @deprecated Use `SOCIAL_ICON_TWITCH` from `@/lib/icons`. */

...
import { BlockShadowButton, Button } from "@/components/ui";
...
export function DesktopTitleBar() {
  ...
  return (
    ...
    >
      <div className="relative isolate overflow-visible bg-card">
        <div className="relative z-[1] grid h-10 w-full grid-cols-[auto_minmax(0,1fr)_auto] items-center gap-2 pr-3">
          ...
          <div className="flex shrink-0 items-center gap-1.5">
            <button
              type="button"
              onClick={openSearch}
              className={cn(layout.desktopTitleBarControl, "p-1.5")}
              aria-label="Search"
              title="Search"
            >
            ...
            {isAuthenticated ? (
              <>
                <BlockShadowButton
                  ...
                  size="sm"
                  shadow="sm"
                  className="desktop-titlebar-control shrink-0 gap-1 whitespace-nowrap px-2 py-1"

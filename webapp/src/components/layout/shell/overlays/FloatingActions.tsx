        ...
        <AnimatePresence>
          {feedbackVisible && (
            <motion.button
              ...
              className={cn(
                "flex items-center justify-center gap-2 px-3 py-2.5 border-2 border-border bg-card text-foreground",
                SHADOW,
                "hover:bg-primary hover:text-primary-foreground hover:border-primary active:translate-x-0.5 active:translate-y-0.5 active:shadow-none transition-all text-[10px] font-black uppercase tracking-widest",
              )}
            >

...
export function RankCountPill({
  ...
  const text =
    count >= 1000000
      ? `${(count / 1000000).toFixed(count % 1000000 === 0 ? 0 : 1).replace(/\.0$/, "")}M`
      : count >= 10000
  ...
  return (
    <span
      className={cn(
        "inline-flex min-h-8 min-w-8 shrink-0 items-center justify-center  px-1.5 font-mono text-[10px] font-black tabular-nums ring-1 ring-inset",
        tone === "inverse"

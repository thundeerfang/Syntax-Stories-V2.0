  ...
  return (
    <article
      className={cn(
        ...
        status === 'unlocked' && 'border-primary/50 bg-primary/[0.03] shadow-[3px_3px_0_0] shadow-primary/15',
    ...
    >
      <div className="mb-4 flex items-start justify-between gap-3">
        ...
        <span
          className={cn(
            ...
            status === 'unlocked' && 'border-primary/40 bg-primary/10 text-primary',
            status === 'locked' && 'border-border bg-muted/50 text-muted-foreground',
            status === 'in_progress' && 'border-border bg-background text-foreground'
          )}
        >
          {status === 'unlocked' ? (
      ...
      <div className="flex min-h-0 flex-1 flex-col">
        ...
        >
          {status === 'locked' ? 'Complete earlier milestones to reveal this badge.' : item.description}
        </p>

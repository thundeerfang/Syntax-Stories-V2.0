      ...
      <div className="flex flex-col gap-4">
        ...
        {!imageUrl && (
          <ImageDropzone
            ...
            className={cn(
              'flex min-h-[152px] w-full flex-col items-center justify-center border-2 border-dashed  px-6 py-8 text-center transition-colors cursor-pointer outline-none focus-visible:ring-2 focus-visible:ring-primary/40',
          ...
          >
            <p className="text-sm font-bold text-foreground text-balance max-w-[16rem]">
              Drop an image here or click to browse
            </p>
            <p className="text-[10px] text-muted-foreground mt-2 text-balance max-w-[16rem]">
              Profile photo will be updated
            </p>
          </ImageDropzone>
        )}
        ...
        {imageUrl && (
          <div className="flex flex-col gap-4">
            <CropperKeyboardWrapper
              imageReady={!!imageUrl}
              className="w-full h-56 overflow-hidden bg-muted border border-border"
            >
              <Cropper
                image={imageUrl}
                crop={crop}
            ...
            <p className="text-[9px] font-bold uppercase tracking-wide text-muted-foreground">
              Tip: focus the crop frame (click it), then arrow keys to pan. Hold Shift for smaller
              steps.
            </p>
            {uploading && (
            ...
            <div className="flex justify-end gap-2">
              ...
              <button
                ...
                className="px-4 py-1.5 text-[10px] font-bold uppercase border-2 border-border bg-primary text-primary-foreground shadow hover:brightness-110 disabled:opacity-60"
              >

...
/**
 * Static About page seed — edit this file to update copy, journey, tech stack, and team links.
 * Developer portraits live in `webapp/public/developers/`.
 */
export const ABOUT_PAGE_SEED: AboutPageContent = {
  ...
  journey: [
    {
      year: '2024',
      event: 'Syntax Stories concept — a retro-styled dev publishing platform with squads and gamification.',
    },
    {
      year: '2025',
      event: 'Web and mobile clients shipped with rich blog editor, OAuth, bookmarks, and explore lanes.',
    },
    {
      year: '2026',
      event: 'Achievements, realtime unlocks, billing, admin RBAC, and storage guard rolled out across the stack.',
    },
  ],
  techStack: [
  ...
  features: [
    {
      ...
      description: 'Block-based editor with code, diagrams, embeds, and deploy-ready taxonomy.',
      icon: 'Terminal',
    },
    {
      title: 'Squads & feeds',
      description: 'Follow categories, join squads, and surface trending lanes tuned for developers.',
      icon: 'Layers',
    },
    {
      title: 'Gamification',
      description: 'Streaks, achievements, and respect — progress you can see and celebrate.',
      icon: 'BrainCircuit',
    },
  ],
  teamSection: {
  ...
  cta: {
    title: 'Ready to\nScale?',
    description: 'Create an account, draft your first post, and join the Syntax Stories community.',

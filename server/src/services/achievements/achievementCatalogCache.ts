...
import {
  buildAchievementMetricIndex,
  type AchievementMetricIndex,
} from "./metricIndex.js";
  ...
  if (redis) {
    try {
      ...
      if (raw) {
        ...
        const idx = new Map(
          Object.entries(parsed.metricIndex),
        ) as AchievementMetricIndex;
        memoryCache = {
          data: parsed,
          metricIndex: idx,

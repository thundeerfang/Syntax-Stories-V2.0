...
const multipartBase = z.object({
  ...
  clientMeta: z.string().max(50000).optional(),
...
export function parseMultipartFeedback(body: Record<string, unknown>):
  | {
      ok: true;

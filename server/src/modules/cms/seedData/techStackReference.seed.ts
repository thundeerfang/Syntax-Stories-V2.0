/** Bootstrap rows for profile stack & tools autocomplete. */

import type { TechStackReferenceCategory } from '../../../models/TechStackReference.js';

export type TechStackReferenceSeedRow = Readonly<{
  name: string;
  slug: string;
  category: TechStackReferenceCategory;
}>;

export const TECH_STACK_REFERENCE_SEED: TechStackReferenceSeedRow[] = [
  // Frontend

...
const ReferralShareEventSchema = new Schema<IReferralShareEvent>(
  {
    ...
    channel: { type: String, required: true, trim: true, maxlength: 32, index: true },
    referralCode: { type: String, trim: true, maxlength: 16 },
  },
  { timestamps: { createdAt: true, updatedAt: false }, collection: 'referralshareevents' }
);
...
export const ReferralShareEventModel: Model<IReferralShareEvent> =
  ...
  mongoose.model<IReferralShareEvent>('ReferralShareEvent', ReferralShareEventSchema);

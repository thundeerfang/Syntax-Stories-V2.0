...
/** Idempotent bootstrap catalog for `/api/reference/tech-stack` autocomplete. */
export const TECH_STACK_REFERENCE_SEED: TechStackSeedRow[] = [
  ...
  { name: 'TypeScript', slug: 'typescript', category: 'Language', iconSlug: 'ts' },
  { name: 'JavaScript', slug: 'javascript', category: 'Language', iconSlug: 'js' },
  { name: 'HTML', slug: 'html', category: 'Language' },
  { name: 'CSS', slug: 'css', category: 'Language' },
  { name: 'Tailwind CSS', slug: 'tailwindcss', category: 'Frontend', iconSlug: 'tailwind' },
  ...
  { name: 'Three.js', slug: 'threejs', category: 'Library', iconSlug: 'threejs' },
  { name: 'Material UI', slug: 'materialui', category: 'Library', iconSlug: 'materialui' },
  // Backend
  ...
  { name: 'React Native', slug: 'react-native', category: 'Mobile', iconSlug: 'react' },
  { name: 'Android Studio', slug: 'androidstudio', category: 'Tool', iconSlug: 'androidstudio' },
  { name: 'Xcode', slug: 'xcode', category: 'Tool' },
  // Database
  { name: 'MongoDB', slug: 'mongodb', category: 'Database' },
  { name: 'PostgreSQL', slug: 'postgresql', category: 'Database', iconSlug: 'postgresql' },
  ...
  { name: 'Kubernetes', slug: 'kubernetes', category: 'DevOps', iconSlug: 'kubernetes' },
  ...
  { name: 'GitHub Actions', slug: 'githubactions', category: 'DevOps', iconSlug: 'githubactions' },
  ...
  { name: 'Adobe XD', slug: 'adobexd', category: 'Design', iconSlug: 'adobexd' },

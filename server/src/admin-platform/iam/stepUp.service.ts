...
export async function markStepUpVerified(sessionId: string, userId: string): Promise<void> {
...
export async function hasValidStepUp(sessionId: string, userId: string): Promise<boolean> {
  const redis = getRedis();

...
/** GET /api/v1/admin/management/iam-metrics */
export async function getIamMetricsHandler(_req: Request, res: Response): Promise<void> {
  ...
  sendAdminOk(res, {
    ...
    derived: {
      refreshSuccessRate:
        refreshTotal > 0 ? Math.round((metrics.refresh_success / refreshTotal) * 1000) / 10 : null,

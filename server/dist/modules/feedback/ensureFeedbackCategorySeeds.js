 ...
 */
export async function ensureFeedbackCategorySeeds() {
    const ist = formatDateTimeIst();
    for (const row of SEEDS) {
        await FeedbackCategoryModel.updateOne({ slug: row.slug }, {
            $setOnInsert: {
                slug: row.slug,
                label: row.label,
...
//# sourceMappingURL=ensureFeedbackCategorySeeds.js.map
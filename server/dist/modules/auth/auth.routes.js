...
import { idempotency, sendOtpValidation, signupEmailValidation, verifyOtpValidation, staffLoginValidation, updateProfileValidation, updateProfileSectionBodyValidation, verifyToken, verifyAltchaIfConfigured, rateLimitSendOtp, rateLimitVerifyOtp, rateLimitSignupEmail, rateLimitStaffLogin, rateLimitRefresh, rateLimitUpdateProfile, } from '../../middlewares/auth/index.js';
const router = Router();

...
If you want this **implemented** in the repo following that schedule, switch to **Agent mode** and say “start Week 1 only” (or specify week) — Ask mode is guidance only.